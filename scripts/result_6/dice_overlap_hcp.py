...
if __name__ == "__main__":
    ...
    for counter_p, p in enumerate(group_strength_list):
        for counter_w, w in enumerate(spatial_list):
            ...
            indiv_par_1_path = '/home/dzhi/Workspace/UKB_indivPar/results/UKB736_validation/ICA_maps/25' + \
                                f'/ICAparcel_UKBrest-2_space-fs32k_ICA25.dlabel.nii'
            indiv_par_2_path = '/home/dzhi/Workspace/UKB_indivPar/results/UKB736_validation/ICA_maps/25' + \
                               f'/ICAparcel_UKBrest-3_space-fs32k_ICA25.dlabel.nii'
            indiv_par_1, indiv_par_2, _ = load_and_intersect(indiv_par_1_path, indiv_par_2_path)
